...
public class DomainUtil {
	...
	public static void main(String[] args) {
		String[] urls = { "http://meiwen.me/src/index.html", "http://1000chi.com/game/index.html",
				"http://see.xidian.edu.cn/cpp/html/1429.html", "https://docs.python.org/2/howto/regex.html",
				...
				"https://pypi.python.org/pypi/publicsuffix/", "http://127.0.0.1:8000", };
		for (String url : urls) {
			for (int i = 1; i < 4; i++) {
				System.out.println(DomainUtil.getDomain(url, i));
			}
		}
	}
}
